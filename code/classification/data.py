...
class SICAP_data:
    def __init__(self, run=0):
        ...
        # load data
        path_features = '../train_feat_ex/save_jpg/{}/features_sicap_norm.pickle'.format(run)
...
class grx_data:
    def __init__(self, run=0):
        ...
        path_features = '../train_feat_ex/save_jpg2/{}/features_grx_norm_compatible.pickle'.format(run)
        print(path_features)
        with open(path_features, 'rb') as fp:
        ...
        self.y_train, self.train_mask = process_labels_cr_v1(self.y_train)
...
class grx_data_agg:
    def __init__(self, agg_method, run):
        ...
        label_df = pd.read_csv("../datos_zenodo/train.csv")
        ...
        label_df_val = pd.read_csv("../datos_zenodo/val.csv")
