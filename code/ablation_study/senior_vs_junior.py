...
for expertise in ['junior', 'senior']:
    for n_inducing in n_inducings:
        for ix_run in range(runs):
            for train_name in train_names:
                for val_name in val_names:
                    # Save_path
                    save_path = 'experiments/{}/{}/{}_{}/{}/'.format(expertise,ix_run,train_name,val_name,n_inducing)
                    ...
                    data_loaded = data.load_data(ix_run, None, expertise=expertise)
